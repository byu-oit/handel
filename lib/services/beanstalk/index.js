        ...
        .then(serviceRole => {
            return getEbExtensionScript(dependenciesDeployContexts)
                .then(ebextensionContent => {
                    ...
                    return ebextensions.addEbextensionsToSourceFile(ebextensionFiles, pathToArtifact)
                        .then(ebextensionsSuccess => {
                            return uploadDeployableArtifactToS3(ownServiceContext);
                        })
                        .then(s3ArtifactInfo => {
                            return ebextensions.deleteAddedEbExtensionsFromDirectory(ebextensionFiles, pathToArtifact)
                                .then(() => {
