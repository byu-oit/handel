    ...
    return getPolicyStatementsForInstanceRole(serviceContext, dependenciesDeployContexts)
        .then(policyStatements => {
            ...
            if (serviceParams.routing && serviceParams.routing.type === 'https') { //HTTPS ALB Listener
                ...
                let certArn = `arn:aws:acm:${accountConfig.region}:${accountConfig.account_id}:certificate/${serviceParams.routing.https_certificate}`;
...
exports.deploy = function (ownServiceContext, ownPreDeployContext, dependenciesDeployContexts) {
    ...
    return deployPhaseCommon.createCustomRole('elasticbeanstalk.amazonaws.com', 'HandelBeanstalkServiceRole', getPolicyStatementsForServiceRole(), ownServiceContext.accountConfig)
        .then(serviceRole => {
