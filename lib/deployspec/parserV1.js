 ...
 */
exports.validateDeploySpec = function (deploySpec) {
 ...
 * 
 * @param {Object} deploySpec - The Object representing the provided YAML deploy spec file
 ...
 */
exports.getEnvironmentContext = function(deploySpec, environmentName, deployVersion) {
    ...
    let environmentContext = new EnvironmentContext(deploySpec.name, deployVersion, environmentName);
    ...
    _.forEach(environmentSpec, function(serviceSpec, serviceName) {
        ...
        var serviceContext = new ServiceContext(deploySpec.name, environmentName, serviceName,
