...
exports.check = function() {
    winston.error("Check Beanstalk -- NOT IMPLEMENTED");
    return [];
}

exports.preDeploy = function(serviceContext) {
    winston.error("PreDeploy Beanstalk -- NOT IMPLEMENTED");
}

exports.bind = function(ownServiceContext, ownPreDeployContext, dependentOfServiceContext, dependentOfPreDeployContext) {
    winston.error("Bind Beanstalk -- NOT IMPLEMENTED");
}
/**
...
exports.deploy = function(ownServiceContext, ownPreDeployContext, dependenciesDeployContexts) {
    ...
    // let applicationName = `${ownServiceContext.appName}_${ownServiceContext.environmentName}_${ownServiceContext.name}`
