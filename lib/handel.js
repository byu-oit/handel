...
exports.deploy = function(accountConfigFilePath, handelFilePath, environmentsToDeploy, deployVersion) {
    return new Promise((resolve, reject) => {
        try {
            //Pull account-level config from the provided file so it can be consumed by the library
            let accountConfig = config(accountConfigFilePath).getAccountConfig();
