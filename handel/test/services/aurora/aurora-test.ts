...
describe('aurora deployer', () => {
    ...
    beforeEach(async () => {
        ...
        serviceContext = new ServiceContext(appName, envName, 'FakeService', new ServiceType(STDLIB_PREFIX, 'aurora'), serviceParams, accountConfig);
    });
