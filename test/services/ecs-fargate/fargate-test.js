...
describe('fargate deployer', function () {
    let sandbox;
    let serviceContext;
    let appName = "FakeApp";
    let envName = "FakeEnv";
    ...
    beforeEach(function () {
        return config(`${__dirname}/../../test-account-config.yml`)
            .then(accountConfig => {
                ...
                serviceContext = new ServiceContext(appName, envName, "FakeService", "ecs-fargate", {}, accountConfig);
            });
    });
    ...
    describe('preDeploy', function () {
        it('should create a security group and add ingress to self and SSH bastion', function () {
            ...
            return ecsFargate.preDeploy(serviceContext)
    ...
    describe('deploy', function () {
        beforeEach(function () {
            serviceContext.params = VALID_FARGATE_CONFIG;
        })
        ...
        it('should deploy the Fargate service stack', function () {
            ...
            //Run the test
            return ecsFargate.deploy(serviceContext, ownPreDeployContext, dependenciesDeployContexts)
                .then(deployContext => {
    ...
    describe('unDeploy', function () {
        it('should undeploy the stack', function () {
            ...
            return ecsFargate.unDeploy(serviceContext)
