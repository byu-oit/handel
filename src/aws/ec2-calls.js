...
exports.getSubnets = function(vpcId) {
    const ec2 = new AWS.EC2({
        apiVersion: '2016-11-15'
    });
    ...
    return ec2.describeSubnets(describeParams).promise()
        .then(describeResponse => {
            return describeResponse.Subnets;
        });
}

exports.getDefaultVpc = function () {
    const ec2 = new AWS.EC2({
        apiVersion: '2016-11-15'
    });
    ...
    return ec2.describeVpcs(describeParams).promise()
        .then(describeResponse => {
