...
function getDeployContext(serviceContext, tableData) {
    ...
    deployContext.policies.push(getTablePolicyForDependentServices(tableData));
    ...
    deployContext.outputs[`DYNAMODB_${appName}_${environmentName}_${serviceName}_TABLE_NAME`] = tableData.Table.TableName;
    deployContext.outputs[`DYNAMODB_${appName}_${environmentName}_${serviceName}_TABLE_ARN`] = tableData.Table.TableArn;
