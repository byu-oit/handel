...
function getDeployContext(serviceContext, fileSystemId, region, fileSystemName) {
    ...
    let envVarKeyPrefix = util.getEnvVarKeyPrefix(serviceContext);
...
exports.deploy = function(ownServiceContext, ownPreDeployContext, dependenciesDeployContexts) {
    let fileSystemName = `${ownServiceContext.appName}-${ownServiceContext.environmentName}-${ownServiceContext.serviceName}`;
