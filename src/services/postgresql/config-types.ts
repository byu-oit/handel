...
export interface PostgreSQLDbParameters {
    [key: string]: string;
}

export interface HandlebarsPostgreSQLTemplate {
    description: string;
    storageGB: number;
    instanceType: string;
    stackName: string;
    ...
    dbPort: number;
    storageType: PostgreSQLStorageType;
    dbSecurityGroupId: string;
    parameterGroupFamily: string;
    tags: Tags;
    parameterGroupParams?: PostgreSQLDbParameters;
    multi_az?: boolean;
}
