...
exports.unDeployService = function (serviceContext, serviceType) {
    ...
    return cloudformationCalls.getStack(stackName)
        ...
        .then(() => {
          // delete s3 artifacts (if any)
          //console.log('account',accountConfig.account_id,'region',accountConfig.region,'context',serviceContext,'type',serviceType);
          console.log(`handel-${accountConfig.region}-${accountConfig.account_id}`,`${serviceContext.appName}/${serviceContext.environmentName}/${serviceContext.serviceName}`);
