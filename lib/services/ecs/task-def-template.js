...
exports.getTaskDefinition = function(serviceContext, taskRoleArn, dependenciesDeployContexts) {
    ...
    let taskDefinition = {
        ...
        containerDefinitions: [{
            ...
            entryPoint: null, //Not supported, use Dockerfile instead
            command: null, //Not supported, use Dockerfile instead
            workingDirectory: null, //Not supported, use Dockerfile instead=
            links: null, //Multi-container services not supported yet
            volumesFrom: null,
